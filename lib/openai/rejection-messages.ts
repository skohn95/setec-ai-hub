/**
 * Rejection message shown when the Filter Agent determines a message is off-topic.
 * This message is in Spanish as specified in the PRD.
 * Tone: Polite, apologetic, and helpful - redirects user without being harsh.
 */
